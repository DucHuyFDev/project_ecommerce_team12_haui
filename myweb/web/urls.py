...
from .views import home_view, category_view, product_view, auth_view, profile_view, cart_view, checkout_view, api_view, chatbot_view
...
urlpatterns = [
    ...
    path('tai-khoan/lich-su-thanh-toan/', profile_view.payment_history, name='payment_history'),
    ...
    path("chatbot/ask/", chatbot_view.chat_ask, name="chat_ask"),
]
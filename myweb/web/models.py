...
class Payment_VNPay(models.Model):
    ...
    vnp_TransactionNo = models.CharField(max_length=50, null=True, blank=True)
    vnp_ResponseCode = models.CharField(max_length=10, null=True, blank=True)
    
    class Meta:
        db_table = 'web_payment_vnpay'
        verbose_name = 'Lịch sử thanh toán VNPay'
        verbose_name_plural = 'Lịch sử thanh toán VNPay'
